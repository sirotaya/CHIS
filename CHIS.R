...
# UNUSUAL VALUES: It looks like everyone 85 and above has been categorized as 85 years old.
# DEFAULT BINWIDTHS: The binwidth for the age variable, SRAGE_P, of the adult dataset is 2.23

# DATA CLEANING:
#---------------
# Remove individual above or equal age 84
...
# Plot 3 - Faceted count histogramv
ggplot(adult, aes (x = SRAGE_P, fill= factor(RBMI))) + 
  geom_histogram(binwidth = 1) +
  BMI_fill + 
  facet_grid(RBMI ~ .)
